...
type ApiConfirmQRCodeLoginRequest struct {
	ctx context.Context
...
// 登录确认请求参数
func (r ApiConfirmQRCodeLoginRequest) QRCodeSignInRequest(qRCodeSignInRequest QRCodeSignInRequest) ApiConfirmQRCodeLoginRequest {
	r.qRCodeSignInRequest = &qRCodeSignInRequest
	return r
}

func (r ApiConfirmQRCodeLoginRequest) Execute() (*TokenModelApiResponse, *http.Response, error) {
	return r.ApiService.ConfirmQRCodeLoginExecute(r)
}
...
微信小程序用户确认二维码登录并获取访问令牌
 ...
 @param appKey
 @return ApiConfirmQRCodeLoginRequest
*/
func (a *WechatAPIService) ConfirmQRCodeLogin(ctx context.Context, appKey string) ApiConfirmQRCodeLoginRequest {
	return ApiConfirmQRCodeLoginRequest{
		ApiService: a,
		ctx: ctx,
		appKey: appKey,
...
func (a *WechatAPIService) ConfirmQRCodeLoginExecute(r ApiConfirmQRCodeLoginRequest) (*TokenModelApiResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WechatAPIService.ConfirmQRCodeLogin")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/Wechat/{appKey}/QR-Auth/Confirm-Login"
...
type ApiConfirmQRCodeRegistrationRequest struct {
	ctx context.Context
	ApiService *WechatAPIService
	appKey string
...
// 注册确认请求参数
func (r ApiConfirmQRCodeRegistrationRequest) QRCodeSignUpRequest(qRCodeSignUpRequest QRCodeSignUpRequest) ApiConfirmQRCodeRegistrationRequest {
	r.qRCodeSignUpRequest = &qRCodeSignUpRequest
	return r
}

func (r ApiConfirmQRCodeRegistrationRequest) Execute() (*TokenModelApiResponse, *http.Response, error) {
	return r.ApiService.ConfirmQRCodeRegistrationExecute(r)
}
...
微信小程序用户通过二维码完成注册并获取访问令牌
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param appKey
 @return ApiConfirmQRCodeRegistrationRequest
*/
func (a *WechatAPIService) ConfirmQRCodeRegistration(ctx context.Context, appKey string) ApiConfirmQRCodeRegistrationRequest {
	return ApiConfirmQRCodeRegistrationRequest{
		ApiService: a,
		ctx: ctx,
		appKey: appKey,
...
// Execute executes the request
//  @return TokenModelApiResponse
func (a *WechatAPIService) ConfirmQRCodeRegistrationExecute(r ApiConfirmQRCodeRegistrationRequest) (*TokenModelApiResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WechatAPIService.ConfirmQRCodeRegistration")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/Wechat/{appKey}/QR-Auth/Confirm-Register"
	localVarPath = strings.Replace(localVarPath, "{"+"appKey"+"}", url.PathEscape(parameterValueToString(r.appKey, "appKey")), -1)
...
type ApiInitiateQRAuthSessionRequest struct {
	ctx context.Context
	ApiService *WechatAPIService
	appKey string
...
// 认证会话初始化请求参数
func (r ApiInitiateQRAuthSessionRequest) QRCodePreSignInRequest(qRCodePreSignInRequest QRCodePreSignInRequest) ApiInitiateQRAuthSessionRequest {
	r.qRCodePreSignInRequest = &qRCodePreSignInRequest
	return r
}

func (r ApiInitiateQRAuthSessionRequest) Execute() (*Int64ApiResponse, *http.Response, error) {
	return r.ApiService.InitiateQRAuthSessionExecute(r)
}
...
创建用于微信小程序扫码登录/注册的认证会话
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param appKey
 @return ApiInitiateQRAuthSessionRequest
*/
func (a *WechatAPIService) InitiateQRAuthSession(ctx context.Context, appKey string) ApiInitiateQRAuthSessionRequest {
	return ApiInitiateQRAuthSessionRequest{
		ApiService: a,
		ctx: ctx,
		appKey: appKey,
...
func (a *WechatAPIService) InitiateQRAuthSessionExecute(r ApiInitiateQRAuthSessionRequest) (*Int64ApiResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WechatAPIService.InitiateQRAuthSession")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/Wechat/{appKey}/QR-Auth/Initiate"
	localVarPath = strings.Replace(localVarPath, "{"+"appKey"+"}", url.PathEscape(parameterValueToString(r.appKey, "appKey")), -1)
...
type ApiScanQRCodeForAuthRequest struct {
	ctx context.Context
	ApiService *WechatAPIService
	appKey string
...
// 二维码扫描请求参数
func (r ApiScanQRCodeForAuthRequest) QRCodeScanRequest(qRCodeScanRequest QRCodeScanRequest) ApiScanQRCodeForAuthRequest {
	r.qRCodeScanRequest = &qRCodeScanRequest
	return r
}

func (r ApiScanQRCodeForAuthRequest) Execute() (*UserQRCodeScanResultApiResponse, *http.Response, error) {
	return r.ApiService.ScanQRCodeForAuthExecute(r)
}
...
微信小程序扫描二维码并获取应用授权信息
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param appKey
 @return ApiScanQRCodeForAuthRequest
*/
func (a *WechatAPIService) ScanQRCodeForAuth(ctx context.Context, appKey string) ApiScanQRCodeForAuthRequest {
	return ApiScanQRCodeForAuthRequest{
		ApiService: a,
		ctx: ctx,
		appKey: appKey,
...
func (a *WechatAPIService) ScanQRCodeForAuthExecute(r ApiScanQRCodeForAuthRequest) (*UserQRCodeScanResultApiResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WechatAPIService.ScanQRCodeForAuth")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/Wechat/{appKey}/QR-Auth/Scan"
	localVarPath = strings.Replace(localVarPath, "{"+"appKey"+"}", url.PathEscape(parameterValueToString(r.appKey, "appKey")), -1)
...
func (r ApiWechatGenerateSchemeRequest) RequestBody(requestBody []interface{}) ApiWechatGenerateSchemeRequest {
...
type ApiWechatMsgSecCheckRequest struct {
	ctx context.Context
	ApiService *WechatAPIService
	appKey string
	requestBody *[]interface{}
...
// 消息内容数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/OpenApiDoc/sec-center/sec-check/msgSecCheck.html
func (r ApiWechatMsgSecCheckRequest) RequestBody(requestBody []interface{}) ApiWechatMsgSecCheckRequest {
	r.requestBody = &requestBody
	return r
}

func (r ApiWechatMsgSecCheckRequest) Execute() (interface{}, *http.Response, error) {
	return r.ApiService.WechatMsgSecCheckExecute(r)
}
...
检测消息内容是否含有违法违规信息
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param appKey
 @return ApiWechatMsgSecCheckRequest
*/
func (a *WechatAPIService) WechatMsgSecCheck(ctx context.Context, appKey string) ApiWechatMsgSecCheckRequest {
	return ApiWechatMsgSecCheckRequest{
		ApiService: a,
		ctx: ctx,
		appKey: appKey,
...
// Execute executes the request
//  @return interface{}
func (a *WechatAPIService) WechatMsgSecCheckExecute(r ApiWechatMsgSecCheckRequest) (interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WechatAPIService.WechatMsgSecCheck")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/Wechat/{appKey}/MsgSecCheck"
	localVarPath = strings.Replace(localVarPath, "{"+"appKey"+"}", url.PathEscape(parameterValueToString(r.appKey, "appKey")), -1)
...
func (r ApiWechatSubscribeMSGRequest) RequestBody(requestBody []interface{}) ApiWechatSubscribeMSGRequest {
	r.requestBody = &requestBody
	return r
}
...
func (r ApiWechatSubscribeSendRequest) RequestBody(requestBody []interface{}) ApiWechatSubscribeSendRequest {
	r.requestBody = &requestBody
	return r
}
...
func (r ApiWechatUrlLinkGenerateRequest) RequestBody(requestBody []interface{}) ApiWechatUrlLinkGenerateRequest {
	r.requestBody = &requestBody
	return r
}
...
func (r ApiWechatWXACodeGetRequest) RequestBody(requestBody []interface{}) ApiWechatWXACodeGetRequest {
	r.requestBody = &requestBody
	return r
}
...
func (r ApiWechatWXACodeGetUnlimitedRequest) RequestBody(requestBody []interface{}) ApiWechatWXACodeGetUnlimitedRequest {
	r.requestBody = &requestBody
	return r
}
