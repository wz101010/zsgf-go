...
// checks if the AppSettingApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppSettingApiResponse{}

// AppSettingApiResponse struct for AppSettingApiResponse
type AppSettingApiResponse struct {
	// 状态码
...
func (o *AppSettingApiResponse) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o AppSettingApiResponse) MarshalJSON() ([]byte, error) {
...
func (o AppSettingApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAppSettingApiResponse struct {
	value *AppSettingApiResponse
	isSet bool
}

func (v NullableAppSettingApiResponse) Get() *AppSettingApiResponse {
	return v.value
}

func (v *NullableAppSettingApiResponse) Set(val *AppSettingApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppSettingApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppSettingApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppSettingApiResponse(val *AppSettingApiResponse) *NullableAppSettingApiResponse {
	return &NullableAppSettingApiResponse{value: val, isSet: true}
}

func (v NullableAppSettingApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppSettingApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
