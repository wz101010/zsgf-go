...
**Enable** | Pointer to **NullableBool** | 启用 | [optional] 
**ShowIndex** | Pointer to **NullableInt32** | 排序 | [optional] 
...
`func (o *GeoLocationResponseModel) SetEnableNil(b bool)`
...
`func (o *GeoLocationResponseModel) SetShowIndexNil(b bool)`
