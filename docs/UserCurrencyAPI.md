...
> UserCurrencyListApiResponse UserCurrencies(ctx, appKey, id).UserId(userId).Execute()
...
func main() {
	...
	resp, r, err := apiClient.UserCurrencyAPI.UserCurrencies(context.Background(), appKey, id).UserId(userId).Execute()
	if err != nil {
...
> BooleanApiResponse UserCurrencyConsume(ctx, appKey).Nonce(nonce).Timestamp(timestamp).Signature(signature).UserId(userId).CurrencyConsumeRequest(currencyConsumeRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserCurrencyAPI.UserCurrencyConsume(context.Background(), appKey).Nonce(nonce).Timestamp(timestamp).Signature(signature).UserId(userId).CurrencyConsumeRequest(currencyConsumeRequest).Execute()
	if err != nil {
...
> BooleanApiResponse UserCurrencyExchange(ctx, appKey).Nonce(nonce).Timestamp(timestamp).Signature(signature).UserId(userId).ExchangeCurrencyRequest(exchangeCurrencyRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserCurrencyAPI.UserCurrencyExchange(context.Background(), appKey).Nonce(nonce).Timestamp(timestamp).Signature(signature).UserId(userId).ExchangeCurrencyRequest(exchangeCurrencyRequest).Execute()
	if err != nil {
...
> BooleanApiResponse UserCurrencyRecharge(ctx, appKey).Nonce(nonce).Timestamp(timestamp).Signature(signature).UserId(userId).RechargePointRequest(rechargePointRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserCurrencyAPI.UserCurrencyRecharge(context.Background(), appKey).Nonce(nonce).Timestamp(timestamp).Signature(signature).UserId(userId).RechargePointRequest(rechargePointRequest).Execute()
	if err != nil {
...
> UserCurrencyCurrencyTransResultApiResponse UserCurrencyTransactions(ctx, appKey).TransType(transType).CurCode(curCode).StartTime(startTime).EndTime(endTime).Skip(skip).Take(take).UserId(userId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserCurrencyAPI.UserCurrencyTransactions(context.Background(), appKey).TransType(transType).CurCode(curCode).StartTime(startTime).EndTime(endTime).Skip(skip).Take(take).UserId(userId).Execute()
	if err != nil {
