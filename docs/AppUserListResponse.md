...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **int64** | 用户ID | [optional] 
**UnionID** | Pointer to **NullableString** | 用户的联合ID | [optional] 
**Platform** | Pointer to **NullableString** | 用户所在平台 | [optional] 
**UserName** | Pointer to **NullableString** | 用户名 | [optional] 
**NickName** | Pointer to **NullableString** | 用户昵称 | [optional] 
**Email** | Pointer to **NullableString** | 用户邮箱 | [optional] 
**Phone** | Pointer to **NullableString** | 用户电话 | [optional] 
**Avatar** | Pointer to **NullableString** | 用户头像URL | [optional] 
**Role** | Pointer to **NullableString** | 用户角色 | [optional] 
**RoleID** | Pointer to **int64** | 用户角色ID | [optional] 
**CreateDate** | Pointer to **time.Time** | 用户创建日期 | [optional] 
**LastUpdate** | Pointer to **time.Time** | 用户最后更新日期 | [optional] 
