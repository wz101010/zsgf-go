...
------------ | ------------- | ------------- | -------------
**Title** | Pointer to **NullableString** | 访问令牌的标题 | [optional] [default to ""]
...
**Enable** | Pointer to **NullableBool** | 是否启用访问令牌 | [optional] 
...
`func (o *AccessTokenPutRequest) SetTitleNil(b bool)`
...
`func (o *AccessTokenPutRequest) SetEnableNil(b bool)`
