...
------------ | ------------- | ------------- | -------------
**Scopes** | Pointer to **NullableString** | 授权范围，长度不能超过100个字符，只能包含字母、数字和逗号 | [optional] 
**Remark** | Pointer to **NullableString** | 备注，长度不能超过200个字符 | [optional] 
**Scheme** | Pointer to **NullableString** | 方案，长度不能超过50个字符，只能包含字母和数字 | [optional] 
