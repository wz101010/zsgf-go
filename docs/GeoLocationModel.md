...
`func NewGeoLocationModel(latitude float64, longitude float64, locationType string, ) *GeoLocationModel`
...
`func (o *GeoLocationModel) SetEnableNil(b bool)`

 SetEnableNil sets the value for Enable to be an explicit nil

### UnsetEnable
`func (o *GeoLocationModel) UnsetEnable()`
...
`func (o *GeoLocationModel) SetShowIndexNil(b bool)`

 SetShowIndexNil sets the value for ShowIndex to be an explicit nil

### UnsetShowIndex
`func (o *GeoLocationModel) UnsetShowIndex()`
