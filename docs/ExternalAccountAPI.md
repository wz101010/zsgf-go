...
> TokenModelApiResponse ExternalAccountSignIn(ctx, appKey).ExternalAccountSignInRequest(externalAccountSignInRequest).Execute()
...
func main() {
	...
	resp, r, err := apiClient.ExternalAccountAPI.ExternalAccountSignIn(context.Background(), appKey).ExternalAccountSignInRequest(externalAccountSignInRequest).Execute()
	if err != nil {
...
> BooleanApiResponse UserExternalAccountBind(ctx, appKey).ExternalAccountBindRequest(externalAccountBindRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ExternalAccountAPI.UserExternalAccountBind(context.Background(), appKey).ExternalAccountBindRequest(externalAccountBindRequest).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ExternalAccountAPI.UserOAuthAccounts(context.Background(), appKey).Execute()
	if err != nil {
...
> BooleanApiResponse UserOAuthAccountsPutBind(ctx, id, appKey).ExternalAccountPutRequest(externalAccountPutRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ExternalAccountAPI.UserOAuthAccountsPutBind(context.Background(), id, appKey).ExternalAccountPutRequest(externalAccountPutRequest).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ExternalAccountAPI.UserOAuthAccountsUnBind(context.Background(), id, appKey).Execute()
	if err != nil {
