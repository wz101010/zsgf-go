...
------------ | ------------- | ------------- | -------------
**Avatar** | Pointer to **NullableString** | 用户头像的链接或路径，长度不能超过255个字符 | [optional] 
**Data** | Pointer to **NullableString** | 用户的其他数据，可以是序列化后的对象或JSON字符串 | [optional] 
**NickName** | Pointer to **NullableString** | 用户的昵称，长度不能超过50个字符 | [optional] 
**InterestTags** | Pointer to **NullableString** | 兴趣标签 | [optional] 
**Biography** | Pointer to **NullableString** | 个人简介，长度不能超过500个字符 | [optional] 
**Gender** | Pointer to **NullableString** | 性别，长度不能超过15个字符 | [optional] 
**Birthday** | Pointer to **NullableTime** | 生日 | [optional] 
**Occupation** | Pointer to **NullableString** | 职业，长度不能超过50个字符 | [optional] 
**Education** | Pointer to **NullableString** | 学历，长度不能超过50个字符 | [optional] 
**Contact** | Pointer to **NullableString** | 联系方式，长度不能超过255个字符 | [optional] 
**Languages** | Pointer to **NullableString** | 语言，长度不能超过50个字符 | [optional] 
**SocialLinks** | Pointer to **NullableString** | 社交网络链接，长度不能超过255个字符 | [optional] 
**RelationshipStatus** | Pointer to **NullableString** | 婚姻状态，长度不能超过20个字符 | [optional] 
**Company** | Pointer to **NullableString** | 公司，长度不能超过100个字符 | [optional] 
**Industry** | Pointer to **NullableString** | 行业，长度不能超过50个字符 | [optional] 
**CompanyPosition** | Pointer to **NullableString** | 行业职位，长度不能超过50个字符 | [optional] 
**PrivateSettings** | Pointer to **NullableString** | 私密设置，长度不能超过500个字符 | [optional] 
**Enable2FAAuth** | Pointer to **NullableBool** | 是否启用二步验证 | [optional] 
**EnableUserNameSignIn** | Pointer to **NullableBool** | 是否启用账号登录 | [optional] 
**EnableEmailSignIn** | Pointer to **NullableBool** | 是否启用邮箱登录 | [optional] 
**EnablePhoneSignIn** | Pointer to **NullableBool** | 是否启用手机登录 | [optional] 
**EnableUnionIDSignIn** | Pointer to **NullableBool** | 是否启用UnionID登录 | [optional] 
**EnableOAuth** | Pointer to **NullableBool** | 是否启用OAuth2登录 | [optional] 
...
`func (o *UpdateProfileRequest) GetEnable2FAAuth() bool`

GetEnable2FAAuth returns the Enable2FAAuth field if non-nil, zero value otherwise.

### GetEnable2FAAuthOk

`func (o *UpdateProfileRequest) GetEnable2FAAuthOk() (*bool, bool)`
...
`func (o *UpdateProfileRequest) SetEnable2FAAuth(v bool)`

SetEnable2FAAuth sets Enable2FAAuth field to given value.

### HasEnable2FAAuth

`func (o *UpdateProfileRequest) HasEnable2FAAuth() bool`

HasEnable2FAAuth returns a boolean if a field has been set.

### SetEnable2FAAuthNil

`func (o *UpdateProfileRequest) SetEnable2FAAuthNil(b bool)`

 SetEnable2FAAuthNil sets the value for Enable2FAAuth to be an explicit nil

### UnsetEnable2FAAuth
`func (o *UpdateProfileRequest) UnsetEnable2FAAuth()`

UnsetEnable2FAAuth ensures that no value is present for Enable2FAAuth, not even an explicit nil
### GetEnableUserNameSignIn

`func (o *UpdateProfileRequest) GetEnableUserNameSignIn() bool`

GetEnableUserNameSignIn returns the EnableUserNameSignIn field if non-nil, zero value otherwise.

### GetEnableUserNameSignInOk

`func (o *UpdateProfileRequest) GetEnableUserNameSignInOk() (*bool, bool)`
...
`func (o *UpdateProfileRequest) SetEnableUserNameSignIn(v bool)`

SetEnableUserNameSignIn sets EnableUserNameSignIn field to given value.

### HasEnableUserNameSignIn

`func (o *UpdateProfileRequest) HasEnableUserNameSignIn() bool`

HasEnableUserNameSignIn returns a boolean if a field has been set.

### SetEnableUserNameSignInNil

`func (o *UpdateProfileRequest) SetEnableUserNameSignInNil(b bool)`

 SetEnableUserNameSignInNil sets the value for EnableUserNameSignIn to be an explicit nil

### UnsetEnableUserNameSignIn
`func (o *UpdateProfileRequest) UnsetEnableUserNameSignIn()`

UnsetEnableUserNameSignIn ensures that no value is present for EnableUserNameSignIn, not even an explicit nil
### GetEnableEmailSignIn

`func (o *UpdateProfileRequest) GetEnableEmailSignIn() bool`

GetEnableEmailSignIn returns the EnableEmailSignIn field if non-nil, zero value otherwise.

### GetEnableEmailSignInOk

`func (o *UpdateProfileRequest) GetEnableEmailSignInOk() (*bool, bool)`
...
`func (o *UpdateProfileRequest) SetEnableEmailSignIn(v bool)`

SetEnableEmailSignIn sets EnableEmailSignIn field to given value.

### HasEnableEmailSignIn

`func (o *UpdateProfileRequest) HasEnableEmailSignIn() bool`

HasEnableEmailSignIn returns a boolean if a field has been set.

### SetEnableEmailSignInNil

`func (o *UpdateProfileRequest) SetEnableEmailSignInNil(b bool)`

 SetEnableEmailSignInNil sets the value for EnableEmailSignIn to be an explicit nil

### UnsetEnableEmailSignIn
`func (o *UpdateProfileRequest) UnsetEnableEmailSignIn()`

UnsetEnableEmailSignIn ensures that no value is present for EnableEmailSignIn, not even an explicit nil
### GetEnablePhoneSignIn

`func (o *UpdateProfileRequest) GetEnablePhoneSignIn() bool`

GetEnablePhoneSignIn returns the EnablePhoneSignIn field if non-nil, zero value otherwise.

### GetEnablePhoneSignInOk

`func (o *UpdateProfileRequest) GetEnablePhoneSignInOk() (*bool, bool)`
...
`func (o *UpdateProfileRequest) SetEnablePhoneSignIn(v bool)`

SetEnablePhoneSignIn sets EnablePhoneSignIn field to given value.

### HasEnablePhoneSignIn

`func (o *UpdateProfileRequest) HasEnablePhoneSignIn() bool`

HasEnablePhoneSignIn returns a boolean if a field has been set.

### SetEnablePhoneSignInNil

`func (o *UpdateProfileRequest) SetEnablePhoneSignInNil(b bool)`

 SetEnablePhoneSignInNil sets the value for EnablePhoneSignIn to be an explicit nil

### UnsetEnablePhoneSignIn
`func (o *UpdateProfileRequest) UnsetEnablePhoneSignIn()`

UnsetEnablePhoneSignIn ensures that no value is present for EnablePhoneSignIn, not even an explicit nil
### GetEnableUnionIDSignIn

`func (o *UpdateProfileRequest) GetEnableUnionIDSignIn() bool`

GetEnableUnionIDSignIn returns the EnableUnionIDSignIn field if non-nil, zero value otherwise.

### GetEnableUnionIDSignInOk

`func (o *UpdateProfileRequest) GetEnableUnionIDSignInOk() (*bool, bool)`
...
`func (o *UpdateProfileRequest) SetEnableUnionIDSignIn(v bool)`

SetEnableUnionIDSignIn sets EnableUnionIDSignIn field to given value.

### HasEnableUnionIDSignIn

`func (o *UpdateProfileRequest) HasEnableUnionIDSignIn() bool`

HasEnableUnionIDSignIn returns a boolean if a field has been set.

### SetEnableUnionIDSignInNil

`func (o *UpdateProfileRequest) SetEnableUnionIDSignInNil(b bool)`

 SetEnableUnionIDSignInNil sets the value for EnableUnionIDSignIn to be an explicit nil

### UnsetEnableUnionIDSignIn
`func (o *UpdateProfileRequest) UnsetEnableUnionIDSignIn()`

UnsetEnableUnionIDSignIn ensures that no value is present for EnableUnionIDSignIn, not even an explicit nil
### GetEnableOAuth

`func (o *UpdateProfileRequest) GetEnableOAuth() bool`

GetEnableOAuth returns the EnableOAuth field if non-nil, zero value otherwise.

### GetEnableOAuthOk

`func (o *UpdateProfileRequest) GetEnableOAuthOk() (*bool, bool)`
...
`func (o *UpdateProfileRequest) SetEnableOAuth(v bool)`

SetEnableOAuth sets EnableOAuth field to given value.

### HasEnableOAuth

`func (o *UpdateProfileRequest) HasEnableOAuth() bool`

HasEnableOAuth returns a boolean if a field has been set.

### SetEnableOAuthNil

`func (o *UpdateProfileRequest) SetEnableOAuthNil(b bool)`

 SetEnableOAuthNil sets the value for EnableOAuth to be an explicit nil

### UnsetEnableOAuth
`func (o *UpdateProfileRequest) UnsetEnableOAuth()`

UnsetEnableOAuth ensures that no value is present for EnableOAuth, not even an explicit nil
