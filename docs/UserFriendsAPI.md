...
> UserCommonInterestsResultApiResponse UserCommonInterests(ctx, appKey).Tag(tag).Skip(skip).Take(take).UserId(userId).Execute()
...
func main() {
	...
	userId := "userId_example" // string |  (optional) (default to "")

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserFriendsAPI.UserCommonInterests(context.Background(), appKey).Tag(tag).Skip(skip).Take(take).UserId(userId).Execute()
	if err != nil {
...
> BooleanApiResponse UserFollowUser(ctx, userId, appKey).FromUserId(fromUserId).Execute()
...
func main() {
	...
	appKey := "appKey_example" // string | 
	fromUserId := "fromUserId_example" // string |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserFriendsAPI.UserFollowUser(context.Background(), userId, appKey).FromUserId(fromUserId).Execute()
	if err != nil {
...
> UserFollowersResultApiResponse UserFollowers(ctx, appKey).Tag(tag).Status(status).TargetUserId(targetUserId).Skip(skip).Take(take).UserId(userId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserFriendsAPI.UserFollowers(context.Background(), appKey).Tag(tag).Status(status).TargetUserId(targetUserId).Skip(skip).Take(take).UserId(userId).Execute()
	if err != nil {
...
> BooleanApiResponse UserFollowing(ctx, appKey).Tag(tag).Status(status).TargetUserId(targetUserId).Skip(skip).Take(take).CheckUserId(checkUserId).OnlyIDs(onlyIDs).UserId(userId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserFriendsAPI.UserFollowing(context.Background(), appKey).Tag(tag).Status(status).TargetUserId(targetUserId).Skip(skip).Take(take).CheckUserId(checkUserId).OnlyIDs(onlyIDs).UserId(userId).Execute()
	if err != nil {
...
> UserFriendsNearByResultApiResponse UserFriendsNearBy(ctx, appKey).Longitude(longitude).Latitude(latitude).Country(country).State(state).City(city).District(district).Gender(gender).AgeS(ageS).AgeE(ageE).Tag(tag).Distance(distance).Skip(skip).Take(take).UserId(userId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserFriendsAPI.UserFriendsNearBy(context.Background(), appKey).Longitude(longitude).Latitude(latitude).Country(country).State(state).City(city).District(district).Gender(gender).AgeS(ageS).AgeE(ageE).Tag(tag).Distance(distance).Skip(skip).Take(take).UserId(userId).Execute()
	if err != nil {
...
> UserMutualFollowersResultApiResponse UserMutualFollowers(ctx, appKey).Skip(skip).Take(take).UserId(userId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserFriendsAPI.UserMutualFollowers(context.Background(), appKey).Skip(skip).Take(take).UserId(userId).Execute()
	if err != nil {
...
> UserMutualFollowingsResultApiResponse UserMutualFollowings(ctx, appKey).Skip(skip).Take(take).UserId(userId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserFriendsAPI.UserMutualFollowings(context.Background(), appKey).Skip(skip).Take(take).UserId(userId).Execute()
	if err != nil {
...
> BooleanApiResponse UserUnfollowUser(ctx, userId, appKey).FromUserId(fromUserId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserFriendsAPI.UserUnfollowUser(context.Background(), userId, appKey).FromUserId(fromUserId).Execute()
	if err != nil {
