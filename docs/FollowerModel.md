...
**TargetUserID** | Pointer to **int64** | 目标用户ID | [optional] 
**Alias** | Pointer to **NullableString** | 别名 | [optional] 
**NickName** | Pointer to **NullableString** | 昵称 | [optional] 
**Avatar** | Pointer to **NullableString** | 头像 | [optional] 
**IsMutual** | Pointer to **bool** | 是否互相关注 | [optional] 
**ClosenessScore** | Pointer to **int64** | 亲密度分数 | [optional] 
**AttentionScore** | Pointer to **int64** | 关注度分数 | [optional] 
**Tags** | Pointer to **NullableString** | 标签 | [optional] 
**Status** | Pointer to **NullableString** | 状态 | [optional] 
