...
> GeoLocationModelApiResponse UserLocation(ctx, id, appKey).UserId(userId).Execute()
...
func main() {
	...
	resp, r, err := apiClient.UserLocationAPI.UserLocation(context.Background(), id, appKey).UserId(userId).Execute()
	if err != nil {
...
> BooleanApiResponse UserLocationDelete(ctx, id, appKey).UserId(userId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserLocationAPI.UserLocationDelete(context.Background(), id, appKey).UserId(userId).Execute()
	if err != nil {
...
> UserLocationPostResultApiResponse UserLocationPost(ctx, appKey).UserId(userId).GeoLocationModel(geoLocationModel).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserLocationAPI.UserLocationPost(context.Background(), appKey).UserId(userId).GeoLocationModel(geoLocationModel).Execute()
	if err != nil {
...
> BooleanApiResponse UserLocationPut(ctx, id, appKey).UserId(userId).GeoLocationModel(geoLocationModel).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserLocationAPI.UserLocationPut(context.Background(), id, appKey).UserId(userId).GeoLocationModel(geoLocationModel).Execute()
	if err != nil {
...
> UserLocationsResultApiResponse UserLocations(ctx, appKey).Tag(tag).Type_(type_).X(x).Y(y).Sphere(sphere).Skip(skip).Take(take).UserId(userId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserLocationAPI.UserLocations(context.Background(), appKey).Tag(tag).Type_(type_).X(x).Y(y).Sphere(sphere).Skip(skip).Take(take).UserId(userId).Execute()
	if err != nil {
