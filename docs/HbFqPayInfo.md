...
**FqInstId** | Pointer to **NullableString** |  | [optional] 
...
`func (o *HbFqPayInfo) GetFqInstId() string`

GetFqInstId returns the FqInstId field if non-nil, zero value otherwise.

### GetFqInstIdOk

`func (o *HbFqPayInfo) GetFqInstIdOk() (*string, bool)`

GetFqInstIdOk returns a tuple with the FqInstId field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetFqInstId

`func (o *HbFqPayInfo) SetFqInstId(v string)`

SetFqInstId sets FqInstId field to given value.

### HasFqInstId

`func (o *HbFqPayInfo) HasFqInstId() bool`

HasFqInstId returns a boolean if a field has been set.

### SetFqInstIdNil

`func (o *HbFqPayInfo) SetFqInstIdNil(b bool)`

 SetFqInstIdNil sets the value for FqInstId to be an explicit nil

### UnsetFqInstId
`func (o *HbFqPayInfo) UnsetFqInstId()`

UnsetFqInstId ensures that no value is present for FqInstId, not even an explicit nil
### GetUserInstallNum
