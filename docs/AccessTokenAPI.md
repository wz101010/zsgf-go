...
> BooleanApiResponse AccessTokenDelete(ctx, id, appKey).UserId(userId).Execute()
...
func main() {
	...
	resp, r, err := apiClient.AccessTokenAPI.AccessTokenDelete(context.Background(), id, appKey).UserId(userId).Execute()
	if err != nil {
...
> TokenModelApiResponse AccessTokenPost(ctx, appKey).UserId(userId).AccessTokenPostRequest(accessTokenPostRequest).Execute()
...
func main() {
	appKey := "appKey_example" // string | 
	userId := "userId_example" // string |  (optional)
	accessTokenPostRequest := *openapiclient.NewAccessTokenPostRequest("Title_example") // AccessTokenPostRequest |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AccessTokenAPI.AccessTokenPost(context.Background(), appKey).UserId(userId).AccessTokenPostRequest(accessTokenPostRequest).Execute()
	if err != nil {
 ...
 **userId** | **string** |  | 
 **accessTokenPostRequest** | [**AccessTokenPostRequest**](AccessTokenPostRequest.md) |  | 
...
> BooleanApiResponse AccessTokenPut(ctx, id, appKey).UserId(userId).AccessTokenPutRequest(accessTokenPutRequest).Execute()
...
func main() {
	...
	appKey := "appKey_example" // string | 
	userId := "userId_example" // string |  (optional)
	accessTokenPutRequest := *openapiclient.NewAccessTokenPutRequest() // AccessTokenPutRequest |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AccessTokenAPI.AccessTokenPut(context.Background(), id, appKey).UserId(userId).AccessTokenPutRequest(accessTokenPutRequest).Execute()
	if err != nil {
 ...
 **userId** | **string** |  | 
 **accessTokenPutRequest** | [**AccessTokenPutRequest**](AccessTokenPutRequest.md) |  | 
...
> AccessTokenListResultApiResponse AccessTokens(ctx, appKey).Skip(skip).Take(take).UserId(userId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AccessTokenAPI.AccessTokens(context.Background(), appKey).Skip(skip).Take(take).UserId(userId).Execute()
	if err != nil {
