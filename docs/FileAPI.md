...
func main() {
	appKey := "appKey_example" // string | 
	path := "path_example" // string | 文件 / 文件夹路径 (optional)
...
func main() {
	appKey := "appKey_example" // string | 
	sourceName := "sourceName_example" // string | 原文件 / 文件夹名称 (optional)
	destName := "destName_example" // string | 新文件 / 文件夹名称 (optional)
 ...
 **sourceName** | **string** | 原文件 / 文件夹名称 | 
 **destName** | **string** | 新文件 / 文件夹名称 | 
...
> StringApiResponse FileUpload(ctx, appKey).Path(path).File(file).Execute()
...
func main() {
	...
	// response from `FileUpload`: StringApiResponse
