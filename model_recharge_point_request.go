...
// checks if the RechargePointRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RechargePointRequest{}

// RechargePointRequest struct for RechargePointRequest
type RechargePointRequest struct {
	// 虚拟币代码
...
type _RechargePointRequest RechargePointRequest
...
func (o *RechargePointRequest) SetRemarkNil() {
	o.Remark.Set(nil)
}
...
func (o *RechargePointRequest) SetDescriptionNil() {
...
func (o *RechargePointRequest) SetTagsNil() {
	o.Tags.Set(nil)
}
...
func (o RechargePointRequest) MarshalJSON() ([]byte, error) {
...
func (o RechargePointRequest) ToMap() (map[string]interface{}, error) {
...
func (o *RechargePointRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varRechargePointRequest := _RechargePointRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRechargePointRequest)

	if err != nil {
		return err
	}

	*o = RechargePointRequest(varRechargePointRequest)

	return err
}

type NullableRechargePointRequest struct {
	value *RechargePointRequest
	isSet bool
}

func (v NullableRechargePointRequest) Get() *RechargePointRequest {
	return v.value
}

func (v *NullableRechargePointRequest) Set(val *RechargePointRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableRechargePointRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableRechargePointRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRechargePointRequest(val *RechargePointRequest) *NullableRechargePointRequest {
	return &NullableRechargePointRequest{value: val, isSet: true}
}

func (v NullableRechargePointRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRechargePointRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
