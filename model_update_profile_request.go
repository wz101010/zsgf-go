...
type UpdateProfileRequest struct {
	...
	// 是否启用二步验证
	Enable2FAAuth NullableBool `json:"enable2FAAuth,omitempty"`
	// 是否启用账号登录
	EnableUserNameSignIn NullableBool `json:"enableUserNameSignIn,omitempty"`
	// 是否启用邮箱登录
	EnableEmailSignIn NullableBool `json:"enableEmailSignIn,omitempty"`
	// 是否启用手机登录
	EnablePhoneSignIn NullableBool `json:"enablePhoneSignIn,omitempty"`
	// 是否启用UnionID登录
	EnableUnionIDSignIn NullableBool `json:"enableUnionIDSignIn,omitempty"`
	// 是否启用OAuth2登录
	EnableOAuth NullableBool `json:"enableOAuth,omitempty"`
}
...
// GetEnable2FAAuth returns the Enable2FAAuth field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *UpdateProfileRequest) GetEnable2FAAuth() bool {
	if o == nil || IsNil(o.Enable2FAAuth.Get()) {
		var ret bool
		return ret
	}
	return *o.Enable2FAAuth.Get()
}
...
// SetEnable2FAAuth gets a reference to the given NullableBool and assigns it to the Enable2FAAuth field.
func (o *UpdateProfileRequest) SetEnable2FAAuth(v bool) {
	o.Enable2FAAuth.Set(&v)
}
// SetEnable2FAAuthNil sets the value for Enable2FAAuth to be an explicit nil
func (o *UpdateProfileRequest) SetEnable2FAAuthNil() {
	o.Enable2FAAuth.Set(nil)
}
...
func (o *UpdateProfileRequest) UnsetEnable2FAAuth() {
	o.Enable2FAAuth.Unset()
}

// GetEnableUserNameSignIn returns the EnableUserNameSignIn field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *UpdateProfileRequest) GetEnableUserNameSignIn() bool {
	if o == nil || IsNil(o.EnableUserNameSignIn.Get()) {
		var ret bool
		return ret
	}
	return *o.EnableUserNameSignIn.Get()
}
...
func (o *UpdateProfileRequest) GetEnableUserNameSignInOk() (*bool, bool) {
	...
	return o.EnableUserNameSignIn.Get(), o.EnableUserNameSignIn.IsSet()
}
...
func (o *UpdateProfileRequest) HasEnableUserNameSignIn() bool {
	if o != nil && o.EnableUserNameSignIn.IsSet() {
		return true
	}
...
// SetEnableUserNameSignIn gets a reference to the given NullableBool and assigns it to the EnableUserNameSignIn field.
func (o *UpdateProfileRequest) SetEnableUserNameSignIn(v bool) {
	o.EnableUserNameSignIn.Set(&v)
}
// SetEnableUserNameSignInNil sets the value for EnableUserNameSignIn to be an explicit nil
func (o *UpdateProfileRequest) SetEnableUserNameSignInNil() {
	o.EnableUserNameSignIn.Set(nil)
}
...
func (o *UpdateProfileRequest) UnsetEnableUserNameSignIn() {
	o.EnableUserNameSignIn.Unset()
}

// GetEnableEmailSignIn returns the EnableEmailSignIn field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *UpdateProfileRequest) GetEnableEmailSignIn() bool {
	if o == nil || IsNil(o.EnableEmailSignIn.Get()) {
		var ret bool
		return ret
	}
	return *o.EnableEmailSignIn.Get()
}
...
// SetEnableEmailSignIn gets a reference to the given NullableBool and assigns it to the EnableEmailSignIn field.
func (o *UpdateProfileRequest) SetEnableEmailSignIn(v bool) {
	o.EnableEmailSignIn.Set(&v)
}
// SetEnableEmailSignInNil sets the value for EnableEmailSignIn to be an explicit nil
func (o *UpdateProfileRequest) SetEnableEmailSignInNil() {
	o.EnableEmailSignIn.Set(nil)
}
...
func (o *UpdateProfileRequest) UnsetEnableEmailSignIn() {
	o.EnableEmailSignIn.Unset()
}

// GetEnablePhoneSignIn returns the EnablePhoneSignIn field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *UpdateProfileRequest) GetEnablePhoneSignIn() bool {
	if o == nil || IsNil(o.EnablePhoneSignIn.Get()) {
		var ret bool
		return ret
	}
	return *o.EnablePhoneSignIn.Get()
}
...
// SetEnablePhoneSignIn gets a reference to the given NullableBool and assigns it to the EnablePhoneSignIn field.
func (o *UpdateProfileRequest) SetEnablePhoneSignIn(v bool) {
	o.EnablePhoneSignIn.Set(&v)
}
// SetEnablePhoneSignInNil sets the value for EnablePhoneSignIn to be an explicit nil
func (o *UpdateProfileRequest) SetEnablePhoneSignInNil() {
	o.EnablePhoneSignIn.Set(nil)
}
...
func (o *UpdateProfileRequest) UnsetEnablePhoneSignIn() {
	o.EnablePhoneSignIn.Unset()
}

// GetEnableUnionIDSignIn returns the EnableUnionIDSignIn field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *UpdateProfileRequest) GetEnableUnionIDSignIn() bool {
	if o == nil || IsNil(o.EnableUnionIDSignIn.Get()) {
		var ret bool
		return ret
	}
	return *o.EnableUnionIDSignIn.Get()
}
...
// SetEnableUnionIDSignIn gets a reference to the given NullableBool and assigns it to the EnableUnionIDSignIn field.
func (o *UpdateProfileRequest) SetEnableUnionIDSignIn(v bool) {
	o.EnableUnionIDSignIn.Set(&v)
}
// SetEnableUnionIDSignInNil sets the value for EnableUnionIDSignIn to be an explicit nil
func (o *UpdateProfileRequest) SetEnableUnionIDSignInNil() {
	o.EnableUnionIDSignIn.Set(nil)
}
...
func (o *UpdateProfileRequest) UnsetEnableUnionIDSignIn() {
	o.EnableUnionIDSignIn.Unset()
}

// GetEnableOAuth returns the EnableOAuth field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *UpdateProfileRequest) GetEnableOAuth() bool {
	if o == nil || IsNil(o.EnableOAuth.Get()) {
		var ret bool
		return ret
	}
	return *o.EnableOAuth.Get()
}
...
// SetEnableOAuth gets a reference to the given NullableBool and assigns it to the EnableOAuth field.
func (o *UpdateProfileRequest) SetEnableOAuth(v bool) {
	o.EnableOAuth.Set(&v)
}
// SetEnableOAuthNil sets the value for EnableOAuth to be an explicit nil
func (o *UpdateProfileRequest) SetEnableOAuthNil() {
	o.EnableOAuth.Set(nil)
}
...
func (o UpdateProfileRequest) ToMap() (map[string]interface{}, error) {
	...
	if o.Enable2FAAuth.IsSet() {
		toSerialize["enable2FAAuth"] = o.Enable2FAAuth.Get()
	}
	if o.EnableUserNameSignIn.IsSet() {
		toSerialize["enableUserNameSignIn"] = o.EnableUserNameSignIn.Get()
	}
	if o.EnableEmailSignIn.IsSet() {
		toSerialize["enableEmailSignIn"] = o.EnableEmailSignIn.Get()
	}
	if o.EnablePhoneSignIn.IsSet() {
		toSerialize["enablePhoneSignIn"] = o.EnablePhoneSignIn.Get()
	}
	if o.EnableUnionIDSignIn.IsSet() {
		toSerialize["enableUnionIDSignIn"] = o.EnableUnionIDSignIn.Get()
	}
	if o.EnableOAuth.IsSet() {
		toSerialize["enableOAuth"] = o.EnableOAuth.Get()
	}
