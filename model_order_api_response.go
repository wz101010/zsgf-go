...
// checks if the OrderApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderApiResponse{}

// OrderApiResponse struct for OrderApiResponse
...
func (o *OrderApiResponse) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o OrderApiResponse) MarshalJSON() ([]byte, error) {
...
func (o OrderApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableOrderApiResponse struct {
	value *OrderApiResponse
	isSet bool
}

func (v NullableOrderApiResponse) Get() *OrderApiResponse {
	return v.value
}

func (v *NullableOrderApiResponse) Set(val *OrderApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderApiResponse(val *OrderApiResponse) *NullableOrderApiResponse {
	return &NullableOrderApiResponse{value: val, isSet: true}
}

func (v NullableOrderApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
