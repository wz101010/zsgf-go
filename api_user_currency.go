...
// 
func (r ApiUserCurrenciesRequest) UserId(userId string) ApiUserCurrenciesRequest {
	r.userId = &userId
	return r
}
...
*/
func (a *UserCurrencyAPIService) UserCurrencies(ctx context.Context, appKey string, id string) ApiUserCurrenciesRequest {
	return ApiUserCurrenciesRequest{
		ApiService: a,
		ctx: ctx,
		appKey: appKey,
...
// 
func (r ApiUserCurrencyConsumeRequest) UserId(userId string) ApiUserCurrencyConsumeRequest {
	r.userId = &userId
	return r
}
...
// 
func (r ApiUserCurrencyExchangeRequest) UserId(userId string) ApiUserCurrencyExchangeRequest {
	r.userId = &userId
	return r
}
...
// 
func (r ApiUserCurrencyRechargeRequest) UserId(userId string) ApiUserCurrencyRechargeRequest {
	r.userId = &userId
	return r
}
...
// 
func (r ApiUserCurrencyTransactionsRequest) UserId(userId string) ApiUserCurrencyTransactionsRequest {
	r.userId = &userId
	return r
}
