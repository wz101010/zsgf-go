...
func (r ApiFileUploadRequest) Execute() (*StringApiResponse, *http.Response, error) {
...
func (a *FileAPIService) FileUploadExecute(r ApiFileUploadRequest) (*StringApiResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
