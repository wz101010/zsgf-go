...
type _GeoLocationModel GeoLocationModel
...
func (o *GeoLocationModel) SetEnableNil() {
	o.Enable.Set(nil)
}
...
func (o *GeoLocationModel) SetShowIndexNil() {
	o.ShowIndex.Set(nil)
}
...
func (o *GeoLocationModel) UnmarshalJSON(data []byte) (err error) {
	...
	varGeoLocationModel := _GeoLocationModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGeoLocationModel)

	if err != nil {
		return err
	}

	*o = GeoLocationModel(varGeoLocationModel)
